...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/Host/widget-jquery.autocomplete.css" />
    <link rel="stylesheet" type="text/css" href="/css/Host/widget-cartPanelView.css" />
</head>
		...
		<div class="py-container">
			<div class="yui3-g SortList ">
				<div class="yui3-u Left all-sort-list">
					...
					@foreach($arr as $v)
					<div class="item bo">
							<h3><a href="">{{$v['category_name']}}</a></h3>
							<div class="item-list clearfix">
								...
								@foreach($v['two'] as $k)
									<dl class="fore1">
										...
										<dt><a href="">{{$k['category_name']}}</a></dt>
										@if(isset($k['three']))
											
											<dd>
												@foreach($k['three'] as $b)
												<a href="{{route('goods_list',['id'=>$b['id']])}}">{{$b['category_name']}}</a></em><em>
												@endforeach
											</dd>
					...
					<div id="myCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
					  ...
					  <div class="carousel-inner">
					    ...
					    <a href="http://baidu2.wypxj.com/">
					    	<img src="/img/Host/banner1.jpg"  />
					      </a>
					    </div>
					    <div class="item">
						 <a href="http://baidu2.wypxj.com/">
						<img src="/img/Host/banner2.jpg"  />
					     </a>
					    </div>
					    <div class="item">
						 <a href="http://baidu2.wypxj.com/">
						<img src="/img/Host/banner3.jpg"  />
						</a>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				<li class="yui3-u-1-6  clock">
					<div class="time">
						<img src="/img/Host/clock.png" />
						<h3>今日推荐</h3>
					</div>
				</li>
				<li class="yui3-u-5-24">
					<a href="list.html" target="_blank"><img src="/img/Host/today01.png" /></a>
				</li>
				<li class="yui3-u-5-24">
					<img src="/img/Host/today02.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="/img/Host/today03.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="/img/Host/today04.png" />
				</li>
			</ul>
		</div>
	</div>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic"><img src="/img/Host/like_02.png" alt="" /></a>
								<div class="like-text">
							...
							<dd>
								<a href="" class="pic"><img src="/img/Host/like_01.png" alt="" /></a>
								<div class="like-text">
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="" class="pic"><img src="/img/Host/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/img/Host/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>捷波朗 </p>
									<p>（jabra）BOOSI劲步</p>
									<h3>¥236.00</h3>
							...
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/img/Host/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>欧普</p>
									<p>JYLZ08面板灯平板灯铝</p>
									<h3>¥456.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/img/Host/like_01.png" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
		...
		<div class="py-container">
			...
			<div class="clearfix yui3-g Interest">
				...
				<div class="yui3-u row-405 Interest-conver">
					<img src="/img/Host/interest01.png" />
				</div>
				<div class="yui3-u row-225 Interest-conver-split">
					<h5>好东西</h5>
					<img src="/img/Host/interest02.png" />
					<img src="/img/Host/interest03.png" />
				</div>
				<div class="yui3-u row-405 Interest-conver-split blockgary">
					<h5>品牌街</h5>
					<div class="split-bt">
						<img src="/img/Host/interest04.png" />
					</div>
					<div class="x-img fl">
						<img src="/img/Host/interest05.png" />
					</div>
					<div class="x-img fr">
						<img src="/img/Host/interest06.png" />
					</div>
				</div>
				<div class="yui3-u row-165 brandArea">
					<span class="brand-yline"></span>
					<ul class="yui3-g brand-list">
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand01.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand02.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand03.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand04.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand05.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand06.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand07.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand08.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand09.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand10.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand11.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand12.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand13.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/img/Host/brand03.png" /></li>
					</ul>
				</div>
			</div>
				...
				<div id="tab1" class="tab-pane active">
					<div class="yui3-g Floor-1">
						<div class="yui3-u Left blockgary">
							...
							<img src="/img/Host/floor-1-1.png" />
						</div>
						<div class="yui3-u row-330 floorBanner">
							<div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
								...
								<div class="carousel-inner">
									<div class="active item">
										<img src="/img/Host/floor-1-b01.png">
									</div>
									<div class="item">
										<img src="/img/Host/floor-1-b02.png">
									</div>
									<div class="item">
										<img src="/img/Host/floor-1-b03.png">
									</div>
								</div>
						...
						<div class="yui3-u row-220 split">
							...
							<div class="floor-conver-pit">
								<img src="/img/Host/floor-1-2.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="/img/Host/floor-1-3.png" />
							</div>
						</div>
						<div class="yui3-u row-218 split">
							<img src="/img/Host/floor-1-4.png" />
						</div>
						<div class="yui3-u row-220 split">
							<span class="floor-x-line"></span>
							<div class="floor-conver-pit">
								<img src="/img/Host/floor-1-5.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="/img/Host/floor-1-6.png" />
							</div>
						</div>
					</div>
				</div>
	...
	<div class="brand">
		<div class="py-container">
			<ul class="Brand-list blockgary">
				<li class="Brand-item">
					<img src="/img/Host/brand_21.png" />
				</li>
				<li class="Brand-item"><img src="/img/Host/brand_03.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_05.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_07.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_09.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_11.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_13.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_15.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_17.png" /></li>
				<li class="Brand-item"><img src="/img/Host/brand_19.png" /></li>
			</ul>
		</div>
	</div>
	<!-- 底部栏位 -->
					...
					<div class="tbar-panel-main">
						<div class="tbar-panel-content J-panel-content">
							<div class="jt-history-wrap">
								<ul>
									<!--<li class="jth-item">
										<a href="#" class="/img/Host/-wrap"> <img src=".portal//img/Host/like_03.png" height="100" width="100" /> </a>
										<a class="add-cart-button" href="#" target="_blank">加入购物车</a>
										<a href="#" target="_blank" class="price">￥498.00</a>
									</li>
									<li class="jth-item">
										<a href="#" class="/img/Host/-wrap"> <img src="portal//img/Host/like_02.png" height="100" width="100" /></a>
										<a class="add-cart-button" href="#" target="_blank">加入购物车</a>
										<a href="#" target="_blank" class="price">￥498.00</a>
									</li>-->
								</ul>
...
<!--侧栏面板结束-->
<script type="text/javascript" src="/js/Host/plugins/jquery/jquery.min.js"></script>
...
<script type="text/javascript" src="/js/Host/model/cartModel.js"></script>
<script type="text/javascript" src="/js/Host/czFunction.js"></script>
<script type="text/javascript" src="/js/Host/plugins/jquery.easing/jquery.easing.min.js"></script>
<script type="text/javascript" src="/js/Host/plugins/sui/sui.min.js"></script>
<script type="text/javascript" src="/js/Host/pages/index.js"></script>
<script type="text/javascript" src="/js/Host/widget/cartPanelView.js"></script>
<script type="text/javascript" src="/js/Host/widget/jquery.autocomplete.js"></script>
<script type="text/javascript" src="/js/Host/widget/nav.js"></script>
</body>
