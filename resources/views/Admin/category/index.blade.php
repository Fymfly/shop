 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="{{route('category_create')}}" title="添加分类" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加根级分类</a>
       ...
       <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
				...
				<th width="80px">分类ID</th>
				<th width="250px">分类名称</th>
				<th width="100px">ID</th>
				<th width="100px">父级ID</th>
    ...
    <tr>
		...
		@if( $v->level==0 || $v->level==1)
			...
			<a  href="{{route('category_createt',['id'=>$v->id])}}" value="添加">添加</a>
			<!-- <input href="{{route('category_createt')}}" type="submit" value="add"> -->
		@else
			<?php echo str_repeat('&nbsp;', 8*$v->level) . $v->category_name ?>
		@endif 
		</td>
        <td width="100px"><?php echo $v->level; ?></td>
        <td width="100px"><?php echo $v->parent_id; ?></td>       
        <td width="180px"><?php echo $v->created_at; ?></td>
        <td class="text-l"><?php echo $v->updated_at; ?></td>
        <td class="td-manage">
        <a onClick="member_stop(this,'10001')"  href="javascript:;" title="停用"  class="btn btn-xs btn-success"><i class="icon-ok bigger-120"></i></a> 
        <a title="编辑" href="{{route('category_edit', ['id'=>$v->id])}}"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a> 
        <a title="删除" onclick="confirm('你确定要删除吗？')" href="{{route('category_delete', ['id'=>$v->id])}}"  onclick="member_del(this,'1')" class="btn btn-xs btn-warning" ><i class="icon-trash  bigger-120"></i></a>
       </td>
