...
<div class="clearfix" id="add_picture">
   ...
   <div class="type_title">添加商品</div>
	...
	<form action="{{route('goods_sku_docreate',['id'=>$id])}}" method="post"  enctype="multipart/form-data">
    {{csrf_field()}}
        ...
        <div class="clearfix cl">
           <!-- <ul id="specul">
                ...
                <li>
					<div class="ullist2">
						<label class="form-label col-2">原 价：</label>
						<div class="formControls"><input type="text" id="input-text" value="" placeholder="" id="" name="original_price[]"></div>
					</div>
                </li>
                <li>
					<div class="ullist2">
						<label class="form-label col-2">现 价：</label>
						<div class="formControls"><input type="text" id="input-text" value="" placeholder="" id="" name="present_price[]"></div>
					</div>
                </li>
...
// ==========================添加sku====================================
    ...
    $("#addsku").click(function(){
            ...
            // ++count
            // $("#prev").append(ulstr);
            $("#prev").append(` <div class="clearfix cl">
           <ul id="specul" name="skus[${count}]">
		   		@foreach($attribute_key as $v)
                <li>
					<div class="specli">
						<label class="form-label col-2">{{$v->attr_name}}:</label>
						<select name="skus[${count}][specs][{{$v->id}}]" id="">
							@foreach($v->vals as $k)
							<option value="{{$k->id}}">{{$k->attr_val}}</option>
							@endforeach
						</select>
                ...
                <li>
					<div class="ullist">
						...
						<div class="formControls"><input type="text" id="input-text" value="" placeholder="" id="" name="skus[${count}][sku_name]"></div>
					</div>
                ...
                <li>
					<div class="ullist">
						<label class="form-label col-2">库存：</label>
						<div class="formControls"><input type="text" id="input-text" value="" placeholder="" id="" name="skus[${count}][stock]"></div>
					</div>
                ...
                <li>
					<div class="ullist2">
						<label class="form-label col-2">原 价：</label>
						<div class="formControls"><input type="text" id="input-text" value="" placeholder="" id="" name="skus[${count}][original_price]"></div>
					</div>
                </li>
                <li>
					<div class="ullist2">
						<label class="form-label col-2">现 价：</label>
						<div class="formControls"><input type="text" id="input-text" value="" placeholder="" id="" name="skus[${count}][present_price]"></div>
					</div>
                </li>
