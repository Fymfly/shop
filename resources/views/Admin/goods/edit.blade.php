...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <div class="type_title">添加商品</div>
	<form action="{{route('goods_doedit',['id'=>$goods->id])}}" method="post" class="form form-horizontal" id="form-article-add">
		@csrf
		...
		<div class=" clearfix cl">
			...
			<div class="formControls col-2"><input type="text" class="input-text" value="{{$goods->num}}" placeholder="" id="" name="num"></div>
            </div>
			<div class="Add_p_s">
             <label class="form-label col-2">产&nbsp;&nbsp;&nbsp;&nbsp;地：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="{{$goods->region}}" placeholder="" id="" name="region"></div>
			</div>
            <div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="{{$goods->present_price}}" placeholder="" id="" name="present_price" >元</div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">市场价格：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="{{$goods->original_price}}" placeholder="" id="" name="original_price" >元</div>
			</div>
