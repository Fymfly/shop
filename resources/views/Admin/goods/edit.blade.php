...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <div class="type_title">添加商品</div>
	<form action="{{route('goods_doedit',['id'=>$goods->id])}}" method="post" class="form form-horizontal" id="form-article-add" enctype=multipart/form-data>
		@csrf
		<h3>基本信息</h3>
        <table width="100%">
                <tr>
                    ...
                    <td>
                        <input type='text' size="80" value="{{$goods->goods_name}}" name='goods_name'>
                        <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                    <img src="{{Storage::url( $goods->logo)}}" alt="" width="100px">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="is_state" value="{{$goods->is_state}}" checked> 是
                        <input type="radio" name="is_state" value="{{$goods->is_state}}"> 否
                        <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <textarea value="{{$goods->content}}" name="content" id="" cols="80" rows="10"></textarea>
                        <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" value="{{$goods->region}}" size="80" name="region">
                        <font color="red">*</font>
                    </td>
                </tr>
                <tr>
                        ...
                        <option value="">选择一级分类</option>
                            @foreach ($category as $v)
                                @if($v->id == $category->parent_id) 
                                    <option selected="selected" value="{{$v-id}}">{{$v->category_name}}</option>
                                @else
            ...
            <div id="attr-container">
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <input type='text' value="{{$attribute->attr_name}}" size="80" name='attr_name[]'>
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type='text' value="{{$attribute->attr_value}}" size="80" name='attr_value[]'>
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="image-container">
                <table width="100%">
                    <tr>
                        <td class="label"></td>
                        <td>
                        <img src="{{Storage::url( $goods->bigImage)}}" alt="" width="100px">
            ...
            <div id="sku-container">
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <input type='text' value="$goods->sku_name" size="80" name='sku_name[]'>
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type='text' value="$goods->stock" size="80" name='stock[]'>
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ￥ <input type='text' value="$goods->original_price" size="10" name='original_price[]'> 元
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ￥ <input type='text' value="$goods->present_price" size="10" name='present_price[]'> 元
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
