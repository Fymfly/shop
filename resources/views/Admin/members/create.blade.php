   ...
   <div class="type_title">添加商品</div>
	<form action="{{route('members_docreate')}}" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
         ...
         <input name="sex" type="radio" class="ace" value="男"><span class="lbl">男</span>&nbsp;&nbsp;&nbsp;
        <input name="sex" type="radio" class="ace" value="女"><span class="lbl">女</span>
         </div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>移动电话：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="mobile"></div>
		</div>
        <div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>电子邮件：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="email"></div>
		</div>
        <div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>家庭住址：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="region"></div>
		</div>
        <div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>等级：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="grade_id"></div>
		</div>
